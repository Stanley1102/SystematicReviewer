...
package edu.pitt.search.lucene;
...
public class IndexFilePositions {
  ...
  public static void main(String[] args) {
    String usage = "java pitt.search.lucene.IndexFilePositions <root_directory> [--index index-directory]";
    SimpleCommandLineParser parser = new SimpleCommandLineParser(args);
    if(parser.getValue("indexdir","index")!=null)
    	INDEX_DIR=new File(parser.getValue("indexdir","index"));
